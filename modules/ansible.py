...
def ansible(loader, *args, project=None, variant=None):
    """ Server provisioning.
    """
...
def ansible_doc(loader, *args, project=None, variant=None):
...
def ansible_playbook(loader, *args, project=None, variant=None):
    """ Server provisioning.
    """
    loader.setup_virtualenv()
